...
class customAdminColumnsFloorplan extends BaseController{
	...
	public function g2Builder_floorplan_column($column, $post_id ) {
	...
	public static function g2builders_floorplan_sortable_columns( $columns ) {
	...
	public static function filter_floorplan_by_taxonomies( $post_type, $which ) {
