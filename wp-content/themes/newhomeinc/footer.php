...
?>
	<footer id="colophon" class="site-footer">
        ...
        <?php $footer_privacy_policy = get_field('footer_privacy_policy', 'option'); ?>
            ...
            <div class="container">
                <ul class="footer-copy-right-list">
                    ...
                    <li>
                        ...
                        <a href="<?php echo $footer_privacy_policy['url']; ?>"><?php echo $footer_privacy_policy['title']; ?></a>
                        <?php endif; ?>
                    </li>
                    <li>
                        <i class="copyright-content"> <?php echo esc_html('©'); ?><?php echo date('Y'); ?> New Home Inc. All Rights Reserved.
                            <a href="https://www.grouptwo.com/" target="_blank">Site Designed by GroupTwo</a></i>
                    </li>
                </ul>
            </div>
        </div>
