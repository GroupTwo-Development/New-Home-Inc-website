<?php
/**
 * Template Name: Community Map View
 *
	...
	<main id="primary" class="site-main">
		<?php if ( $query->have_posts() ) : ?>
            ...
            <div class="container pt-3">
                <div class="row" >
                    <div class="col-lg-12" >
                        <div class="acf-map facetwp-template">
			                <?php while ($query->have_posts() ) : $query->the_post(); ?>
                                ...
                                <div class="marker" data-lat="<?php echo $location['lat']; ?>" data-lng="<?php echo $location['lng']; ?>">
                                    <div class="card <?php echo $coming_soon_class; ?>">
                                        ...
                                        <div class="card-body">
                                            <a href="<?php the_permalink(); ?>" rel="bookmark" class="inner-body">
        ...
        <div class="container pt-3 pb-5">
            <section id="search-page-footer-content" data-aos="fade-up-1">
